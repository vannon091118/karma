...
from karma.ml.training_loop import TrainingLoop, CycleResult
from karma.ml.needs_engine import NeedsEngine, NeedPriority
        ...
        for i in range(cycles):
            ...
            if len(recent_rewards) >= 3:
                ...
                if trend in ("degrading", "stable") and below_threshold:
                    ...
                    from karma.ml.needs_engine import Need
                    import hashlib
