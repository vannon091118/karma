...
from karma.ml.needs_engine import NeedsEngine, NeedPriority, Need
from karma.ml.reward_model import RewardModel, RewardSignal
from karma.ml.pattern_learner import PatternLearner
from karma.ml.training_loop import TrainingLoop
from karma.ml.self_improvement import SelfImprovementController
...
class TestMLKernel(unittest.TestCase):
    ...
    def test_controller_safety_stop_on_degrading_rewards(self):
        ...
        from karma.ml.reward_model import ScoreBreakdown
        from karma.ml.needs_engine import NeedPriority
